  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="font-poppins text-2xl text-wine-700">
          Minha Adega
        </h1>
        
        <button
          onClick={() => handleOpenModal()}
          className="bg-wine-700 text-white hover:bg-wine-500 px-4 py-2 h-11 rounded-md font-inter font-medium transition-all"
        >
          <svg
